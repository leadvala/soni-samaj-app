        ...
        <div class="container-fluid">
            <div class="row g-0">
                <div class=" col-lg-4 col-md-6 col-12">
                    <div class="card-mv">
                        <img src="{{ asset('front_assets') }}/assets/images/mission-vission/1.jpg" alt="">
                        <div class="icon">
                            <a href="{{ route('front.event_detail') }}"><i>+</i>
                                <div class="shape">
                                    <svg viewBox="0 0 98 99" fill="none">
                                        <path d="M0 0H98V99C98 99 61.8947 91.6967 42.5526 55.9918C23.2105 20.2869 0 0 0 0Z"
                                            fill="#F74F22" />
                                    </svg>
                                </div>
                            </a>
                        ...
                        <div class="text">
                            <h2><a href="{{ route('front.event_detail') }}">Food & water Charity.</a></h2>
                ...
                <div class=" col-lg-4 col-md-6 col-12">
                    <div class="card-mv">
                        <img src="{{ asset('front_assets') }}/assets/images/mission-vission/2.jpg" alt="">
                        <div class="icon">
                            <a href="{{ route('front.event_detail') }}"><i>+</i>
                                <div class="shape">
                                    <svg viewBox="0 0 98 99" fill="none">
                        ...
                        <div class="text">
                            <h2><a href="{{ route('front.event_detail') }}">Become a volunteer</a></h2>
                ...
                <div class=" col-lg-4 col-md-6 col-12">
                    <div class="card-mv">
                        <img src="{{ asset('front_assets') }}/assets/images/mission-vission/3.jpg" alt="">
                        <div class="icon">
                            <a href="{{ route('front.event_detail') }}"><i>+</i>
                                <div class="shape">
                                    <svg viewBox="0 0 98 99" fill="none">
                        ...
                        <div class="text">
                            <h2><a href="{{ route('front.event_detail') }}">Send gift for children</a></h2>
                ...
                <div class=" col-lg-4 col-md-6 col-12">
                    <div class="card-mv">
                        <img src="{{ asset('front_assets') }}/assets/images/mission-vission/4.jpg" alt="">
                        <div class="icon">
                            <a href="{{ route('front.event_detail') }}"><i>+</i>
                                <div class="shape">
                                    <svg viewBox="0 0 98 99" fill="none">
                        ...
                        <div class="text">
                            <h2><a href="{{ route('front.event_detail') }}">Help for Children</a></h2>
                            <i class="flaticon-handshake"></i>
                        </div>
                    </div>
                </div>
                <div class=" col-lg-4 col-md-6 col-12">
                    <div class="card-mv">
                        <img src="{{ asset('front_assets') }}/assets/images/mission-vission/5.jpg" alt="">
                        <div class="icon">
                            <a href="{{ route('front.event_detail') }}"><i>+</i>
                                <div class="shape">
                                    <svg viewBox="0 0 98 99" fill="none">
                        ...
                        <div class="text">
                            <h2><a href="{{ route('front.event_detail') }}">Event Raised Poor</a></h2>
                            <i class="flaticon-handshake"></i>
                        </div>
                    </div>
                </div>
                <div class=" col-lg-4 col-md-6 col-12">
                    <div class="card-mv">
                        <img src="{{ asset('front_assets') }}/assets/images/mission-vission/6.jpg" alt="">
                        <div class="icon">
                            <a href="{{ route('front.event_detail') }}"><i>+</i>
                                <div class="shape">
                                    <svg viewBox="0 0 98 99" fill="none">
                        ...
                        <div class="text">
                            <h2><a href="{{ route('front.event_detail') }}">A hand for Children</a></h2>
                            <i class="flaticon-handshake"></i>
                        </div>
                    </div>
                </div>
